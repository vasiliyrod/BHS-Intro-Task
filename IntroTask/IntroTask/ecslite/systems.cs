...
namespace IntroTask.ecslite
{
    ...
    public class EcsSystems : IEcsSystems
    {
        ...
        public virtual IEcsSystems AddWorld(EcsWorld world, string name)
        {
            ...
            if (_inited) { throw new Exception("Cant add world after initialization."); }
        ...
        {
#if DEBUG && !LEOECSLITE_NO_SANITIZE_CHECKS
            if (!_inited) { throw new Exception("Cant run without initialization."); }
#endif
